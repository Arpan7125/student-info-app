...
| Joshua George Philip ([@Joshua1804](https://github.com/Joshua1804)) | 2547124 | UI Developer | HTML structure and CSS styling |
| M A Smera ([@ma-smera](https://github.com/ma-smera)) | 2547131 | JavaScript Developer | Client-side interactivity |

> Still to fill in: both teammates' email addresses — in the Project Team cards in
> `index.html` (search for `To be added`).
